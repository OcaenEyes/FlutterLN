...
class _FriendsPageState extends State<FriendsPage> {
  ...
  void initState() {
    ...
    super.initState();
    getfriend(widget.bundle.getMap("userInfo")["phoneNumber"]);
  }
  ...
  void getfriend(String phone) async {
    Dio dio = new Dio();
    Response response;
    response = await dio.get(Address.dev_base_url + "/getFriends",
  ...
  Widget friends() {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return friendItem(context, friendlist[index]);
        });
  }
          ...
          child: ListTile(
            ...
            onTap: () {
              ...
              Navigator.pushNamed(context, PageName.userdetial.toString(),
                  arguments: Bundle()..putMap("userinfo", friend));
            },
          ),
        ),
        Divider(
...
dynamic tools() {
  List toolData = [
    {'text': "心动", 'icon': Icons.face, 'page_name': PageName.heart.toString()},
    {
      'text': "标签",
      'icon': Icons.tag_faces,
      'page_name': PageName.tag.toString()
    },
    {'text': "群聊", 'icon': Icons.group, 'page_name': PageName.group.toString()},
  ];
  return ListView.builder(
      shrinkWrap: true,
